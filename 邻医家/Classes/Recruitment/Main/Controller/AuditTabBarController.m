...
@interface AuditTabBarController ()<IWTabBarDelegate>

@end

@implementation AuditTabBarController
...
- (void)setupAllChildViewControllers
{
    ...
    //2.招聘
    AuditViewController  *enter = [[AuditViewController alloc] init];
